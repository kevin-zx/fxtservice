...
type Site struct {
	...
	SpecialReason        string   `protobuf:"bytes,6,opt,name=special_reason,json=specialReason,proto3" json:"special_reason,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Site) GetSpecialReason() string {
	if m != nil {
...
type SiteKeyword struct {
	...
	SiteKeywordRanks     []*SiteKeywordRank `protobuf:"bytes,7,rep,name=site_keyword_ranks,json=siteKeywordRanks,proto3" json:"site_keyword_ranks,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
var fileDescriptor_551186ad8c086063 = []byte{
	...
	,
}
